  ...
  fields: [
    {
      ...
      type: 'string',
      initialValue: 'Privacy Policy Page Content',
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'titleLine1', title: 'Title Line 1', type: 'string', placeholder: 'PRIVACY' },
        { name: 'titleLine2', title: 'Title Line 2', type: 'string', placeholder: 'POLICY.' },
